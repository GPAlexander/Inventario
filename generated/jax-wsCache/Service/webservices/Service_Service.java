 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://WebServices/", wsdlLocation = "http://localhost:8080/WebService/Service?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://WebServices/", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebService/Service?wsdl");
    ...
    public webservices.Service getServicePort() {
        return super.getPort(new QName("http://WebServices/", "ServicePort"), Service.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicePort")
    public webservices.Service getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WebServices/", "ServicePort"), Service.class, features);
    }
